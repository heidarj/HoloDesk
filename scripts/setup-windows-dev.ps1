...
Write-Host "  5. Run encode HW tests:      .\scripts\host-encode-hardware-tests.ps1"
Write-Host "  6. Smoke H.264 encode:       .\scripts\host-encode-smoke.ps1"
Write-Host "  7. Run QUIC server later:    .\scripts\host-transport-server.ps1 -Bind 0.0.0.0"
Write-Host "  8. Connect from Mac/AVP:     Use <LAN_IP>:$Port as the host address"
Write-Host ""
